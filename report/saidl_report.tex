...
\subsection{Linear Attention (Causal)}
...
\section{Convolution + Attention Hybrid Architectures}
...
\subsection{Design 1: Conv1D Before Attention (\texttt{conv\_before})}
...
\subsection{Design 2: Gated Depthwise Conv FFN (\texttt{gated\_conv\_ffn})}
...
\section{Visualization \& Graphical Analysis}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{../results/plots/training_loss.png}
    \caption{Simulated convergence loss across positional encoding strategies on WikiText-2.}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{../results/plots/extrapolation_ppl.png}
    \caption{Validation perplexity scaling as context length increases beyond $L_{train}=512$.}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{../results/plots/attention_throughput.png}
